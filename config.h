...
#include "modules/backlight_controler/backlight_controler.h"
...
static const basic_key_handling_keybinding_t basic_key_handling_keybindings[] = {
  ...
  {0, XF86XK_MonBrightnessDown, backlight_controler_decrease, NONE, NULL},
  {0, XF86XK_MonBrightnessUp, backlight_controler_increase, NONE, NULL},
...
#include "modules/backlight_controler/backlight_controler.c"
