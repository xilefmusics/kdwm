...
static wm_keybinding_t wm_keybindings[] = {
    ...
    // move client to tag
    {MODKEY|ShiftMask, XK_1, pertag_set_tag_mask_of_focused_client, INTEGER, "1"},
    {MODKEY|ShiftMask, XK_2, pertag_set_tag_mask_of_focused_client, INTEGER, "2"},
    {MODKEY|ShiftMask, XK_3, pertag_set_tag_mask_of_focused_client, INTEGER, "4"},
    {MODKEY|ShiftMask, XK_4, pertag_set_tag_mask_of_focused_client, INTEGER, "8"},
    {MODKEY|ShiftMask, XK_5, pertag_set_tag_mask_of_focused_client, INTEGER, "16"},
    {MODKEY|ShiftMask, XK_6, pertag_set_tag_mask_of_focused_client, INTEGER, "32"},
    {MODKEY|ShiftMask, XK_7, pertag_set_tag_mask_of_focused_client, INTEGER, "64"},
    {MODKEY|ShiftMask, XK_8, pertag_set_tag_mask_of_focused_client, INTEGER, "128"},
    {MODKEY|ShiftMask, XK_9, pertag_set_tag_mask_of_focused_client, INTEGER, "256"},
    {MODKEY|ShiftMask, XK_0, pertag_set_tag_mask_of_focused_client, INTEGER, "-1"},
    ...
    {MODKEY|ControlMask|ShiftMask, XK_1, pertag_add_tag_to_client, INTEGER, "1"},
    {MODKEY|ControlMask|ShiftMask, XK_2, pertag_add_tag_to_client, INTEGER, "2"},
    {MODKEY|ControlMask|ShiftMask, XK_3, pertag_add_tag_to_client, INTEGER, "4"},
    {MODKEY|ControlMask|ShiftMask, XK_4, pertag_add_tag_to_client, INTEGER, "8"},
    {MODKEY|ControlMask|ShiftMask, XK_5, pertag_add_tag_to_client, INTEGER, "16"},
    {MODKEY|ControlMask|ShiftMask, XK_6, pertag_add_tag_to_client, INTEGER, "32"},
    {MODKEY|ControlMask|ShiftMask, XK_7, pertag_add_tag_to_client, INTEGER, "64"},
    {MODKEY|ControlMask|ShiftMask, XK_8, pertag_add_tag_to_client, INTEGER, "128"},
    {MODKEY|ControlMask|ShiftMask, XK_9, pertag_add_tag_to_client, INTEGER, "256"},
    {MODKEY|ControlMask|ShiftMask, XK_0, pertag_add_tag_to_client, INTEGER, "-1"},
};
