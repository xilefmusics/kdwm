void masterstack() {
    ...
    if (num_of_clients == 0) {
        ...
        wm_client_draw(client, 0, 0, wm_global.screen_width, wm_global.screen_height, false);
    } else {
        ...
        for (int i = 0; i < num_of_slaves; i++) {
            ...
            wm_client_draw(client, master_width, i*slave_height, slave_width, slave_height, true);
        }
    }
